...
class PortfolioData {
  ...
  static const String email = 'justinlikemja@gmail.com';
...
''';
  ...
  static const Map<String, String> socialLinks = {
    'github': 'https://github.com/justin-dev-05',
    'linkedin': 'https://www.linkedin.com/in/justin-mahida-a0a92b116/',
    'instagram':
        'https://www.instagram.com/er._justin._05?igsh=Mm42Y3l5aDhiMGJt',
  };
  ...
  static const List<Map<String, dynamic>> projects = [
    {
      ...
      'description':
          'A full-featured e-commerce mobile application with real-time inventory, payment integration, and admin dashboard.',
    ...
    },
    {
      ...
      'description':
          'Personal health companion app with workout tracking, nutrition logging, and progress visualization.',
    ...
    },
    {
      ...
      'description':
          'AI-powered content creation tool that helps writers generate ideas, outlines, and full articles.',
    ...
    },
    {
      ...
      'description':
          'Analytics dashboard for social media managers with scheduling, reporting, and engagement tracking.',
    ...
    },
    {
      ...
      'description':
          'End-to-end travel booking experience with flight search, hotel reservations, and itinerary planning.',
  ...
  static const List<Map<String, dynamic>> experience = [
    ...
    },
    {
      ...
      'period': '2020 - 2022',
      'description':
          'Built cross-platform mobile apps using Flutter, implemented state management solutions, and integrated REST APIs.',
  ...
  static const List<Map<String, dynamic>> services = [
    {
      ...
      'description':
          'Building beautiful, performant cross-platform mobile applications using Flutter.',
      'icon': 'smartphone',
    },
    {
      'title': 'Web Development',
      'description':
          'Creating responsive, modern web applications with React, Vue, or Angular.',
      'icon': 'web',
    },
    {
      'title': 'UI/UX Design',
    ...
    },
    {
      ...
      'description':
          'Building scalable APIs and server-side solutions with Node.js and Python.',
      'icon': 'server',
    },
  ];
  ...
  static const List<Map<String, dynamic>> testimonials = [
    {
      ...
      'quote':
          'Alex delivered exceptional work on our mobile app. The attention to detail and code quality exceeded our expectations.',
    ...
    },
    {
      ...
      'quote':
          'Working with Alex was a pleasure. They understood our requirements perfectly and delivered on time.',
    ...
    },
    {
      ...
      'quote':
          'Alex\'s technical expertise and problem-solving skills are outstanding. Highly recommended!',
